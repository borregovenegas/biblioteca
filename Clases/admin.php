...
class Admin extends Conectar{
    ...
    public function __construct(){
        $this->db=parent::coneccion();//verificar si es que si se llama conexion o coneccion el metodo de la coneccion que iso el pepe
    }
    ...
    public function agregarAdmin($usuario,$nombre,$password,$apellido,$email){
        ...
        $query="insert into momentos (usuario,nombre,password,apellido,email) values ('$usuario','$nombre','$password','$apellido','$email')";
        $datos=$this->db->execute($query);
        $aAdmin=array();
