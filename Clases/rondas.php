...
class Rondas extends Conectar{
    ...
    public function agregarRonda($nombreRonda){
        ...
        $query="insert into Rondas (nombreRonda) values ('$nombreRonda')";
        $datos=$this->db->execute($query);
        $aRonda=array();
    ...
    public function modificarRonda($nombreRonda){
        $nombreRonda=htmlspecialchars($nombreRonda);
       $query="update Rondas set nombreRonda='$nombreRonda'";
        $datos=$this->db->execute($query);
        $aRonda=array();
        $aRonda=($datos)?array('exito'=>true):array('exito'=>false);
        return $aRonda;
    ...
    public function eliminarRonda($nombreRonda){
        $nombreRonda=htmlspecialchars($nombreRonda);
       $query="delete from Rondas where nombre='$nombreRonda'";
        $datos=$this->db->execute($query);
        $aRonda=array();
        $aRonda=($datos)?array('exito'=>true):array('exito'=>false);
        return $aRonda;
